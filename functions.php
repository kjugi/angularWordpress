...
//Load angular
wp_enqueue_script('angularjs', get_template_directory_uri() .'/wp-angular/node_modules/angular/angular.min.js');
wp_enqueue_script('angularjs-route', get_template_directory_uri() .'/wp-angular/node_modules/angular-route/angular-route.min.js');
